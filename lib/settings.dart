...
import 'package:kavach2/helper_function/shared_preference.dart';
...
class _SettingsPageState extends State<SettingsPage> {
  late String _messageHead;
  late int _sosDelayTime;
  late int _sosRepeatInterval;
  late TextEditingController _messageHeadController;
  late TextEditingController _sosDelayTimeController;
  late TextEditingController _sosRepeatIntervalController;
  ...
  Widget _buildSOStimeInterval() {
    return TextFormField(
      ...
      onSaved: (String? value) async {
        ...
        await SharedPreferenceHelper.saveSOSrepeatInterval(
            int.tryParse(value)!);
      },
    );
  }
