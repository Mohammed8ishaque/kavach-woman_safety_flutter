...
import 'package:kavach2/services/SOS_util.dart';
...
class NotificationMethods {
          ...
          if (simulatedStep == maxStep + 1) {
            ...
            await AwesomeNotifications().createNotification(
              content: NotificationContent(
                ...
                channelKey: 'progress_bar',
                title:
                    'SOS is initiating in ${maxStep - simulatedStep} seconds',
  ...
  static void cancelProgressNotification() {
    simulatedStep =
        maxStep + 2; //hits loop break statement in showProgressNotification()
  }
